...
if ( ! function_exists( 'elixir_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function elixir_block_editor_setup() {
		...
		$color_palette = elixir_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'elixir_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function elixir_generate_color_palette() {
		$color_palette = array();
