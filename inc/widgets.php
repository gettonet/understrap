 ...
 */
add_filter( 'dynamic_sidebar_params', 'elixir_widget_classes' );

if ( ! function_exists( 'elixir_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function elixir_widget_classes( $params ) {
...
} // End of if function_exists( 'elixir_widget_classes' ).

add_action( 'widgets_init', 'elixir_widgets_init' );

if ( ! function_exists( 'elixir_widgets_init' ) ) {
	/**
	...
	function elixir_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'elixir' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'elixir' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'elixir' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'elixir' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'elixir' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'elixir' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'elixir' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'elixir' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'elixir' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'elixir' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'elixir' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'elixir' ),
...
} // End of function_exists( 'elixir_widgets_init' ).
