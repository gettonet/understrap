...
if ( ! function_exists( 'elixir_pagination' ) ) {
	/**
	 ...
	 */
	function elixir_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'elixir' ),
				'next_text'          => __( '&raquo;', 'elixir' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'elixir' ),
			)
		);
