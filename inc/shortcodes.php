...
function elixir_preporuke_djubrenja()
{
    ...
    <div class="mb-5 d-flex flex-wrap justify-content-center">
        ...
        <?php elseif (elixir_get_current_language() == 'en') : ?>
            <button type="button" class="btn btn-outline-primary m-1" data-filter=".category-crop-farming">Crop farming</button>
            <button type="button" class="btn btn-outline-primary m-1" data-filter=".category-vegetable-farming">Vegetable farming</button>
            <button type="button" class="btn btn-outline-primary m-1" data-filter=".category-fruit-farming">Fruit farming</button>
            <button type="button" class="btn btn-outline-primary m-1" data-filter=".category-viticulture">Viticulture</button>
        <?php endif;
        ?>
    </div>
