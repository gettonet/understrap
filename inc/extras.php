...
add_filter( 'wp_trim_excerpt', 'elixir_all_excerpts_get_more_link' );

if ( ! function_exists( 'elixir_all_excerpts_get_more_link' ) ) {
	/**
	 ...
	 * @return string
	 */
	function elixir_all_excerpts_get_more_link( $post_excerpt ) {
		if ( ! is_admin() ) {
			$post_excerpt = $post_excerpt . ' [...]<p><a class="btn btn-secondary elixir-read-more-link" href="' . esc_url( get_permalink( get_the_ID() ) ) . '">' . __(
				'Read More...',
				'elixir'
